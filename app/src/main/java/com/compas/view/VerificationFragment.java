...
public class VerificationFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.botonContinuar = view.findViewById(R.id.buttonAcept);
        this.botonReenviar = view.findViewById(R.id.buttonResend);
        this.botonContinuar.setOnClickListener(this);
        this.botonReenviar.setOnClickListener(this);
        return view;
    }

    public AuthenticationFirebase getAuth() {
        return auth;
    }

    public void setAuth(AuthenticationFirebase auth) {
        this.auth = auth;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.buttonAcept:{
                if (!this.auth.comprobarVerificacionEmail()){
                  LogInActivity activity =   (LogInActivity)getActivity();
                  activity.intenToMain();
                }else{
                    Toast.makeText(v.getContext(), "Tienes que verificar el correo", Toast.LENGTH_SHORT).show();
                }
                break;
            }
